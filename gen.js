...
const last = ["나오다","나가다","나쁘다","나이로비","나무","나라","나누다","나누기","나서스","나타내다","나비","나머지","나뭇잎","나물","나흘","나뭇가지","나들이","나빠지다","나침반","나란히","나락","나이트","나이트클럽","나알개를활짝펴고세상을자유롭게날거야노래하며춤추는나는아름다운나비","나전칠기","나진소드","나이스"]
